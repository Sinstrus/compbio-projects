...
6. **NEVER trust annotations for overlapping ORFs**: 
   - User annotations may be incomplete or wrong.
   - For AAP specifically: ALWAYS independently verify by translating the +1 frame relative to VP1 start and locating stop codons.
   - Report both the annotated boundaries AND your independently verified boundaries.
   - If they differ, flag this prominently.
