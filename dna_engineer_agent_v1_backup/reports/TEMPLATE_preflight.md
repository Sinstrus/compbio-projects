...
**Verification Status:** ✅ VERIFIED | ⚠️ PARTIALLY_VERIFIED | ❌ UNVERIFIED
...
| Reference Source | UniProt / NCBI / Fallback |
| Accession | <accession number> |
| Reference Sequence Length | <N> aa |
| Fetch Timestamp | <YYYY-MM-DD HH:MM:SS UTC> |

**Alignment Results:**
| Metric | Value |
|--------|-------|
| Query (Reference) | <UniProt AAP sequence, first 30aa...> |
| Target (Plasmid +1 frame) | <Aligned region, first 30aa...> |
| Identity | <N>% |
| Alignment Start (bp) | <N> |
| Alignment End (bp) | <N> |
| Verified Length | <N> aa |

**Comparison with File Annotation:**
| Source | Start (bp) | End (bp) | Length (aa) |
|--------|------------|----------|-------------|
| File Annotation | <N> | <N> | <N> |
| Ground-Truth Verification | <N> | <N> | <N> |
| Discrepancy | <None / Description> |

**If UNVERIFIED:** <Reason - e.g., "UniProt unavailable", "No AAP hit for this serotype">

### 3.2 ITRs (If Applicable)

| Property | Value |
|----------|-------|
| Verification Status | ✅ VERIFIED / ⚠️ UNVERIFIED / N/A (Rep-Cap helper) |
| Reference Source | NCBI RefSeq |
| Accession | <accession number> |

<Similar structure as AAP if applicable>

### 3.3 Other Verified Entities

<Add sections for any other entities that required ground-truth verification>

---

## 4. Cis-Element Scan Results
...
| AAV_AAP_ORF | AAP | HIGH | ground_truth_verified | ✅/❌ | bp range | |
| ... | ... | ... | ... | ... | ... | ... |
