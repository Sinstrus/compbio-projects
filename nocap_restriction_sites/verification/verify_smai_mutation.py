#!/usr/bin/env python3
"""
Verify that the SmaI mutation at position 2505 is truly silent
"""
...
print("="*80)
print("VERIFYING SmaI MUTATION AT POSITION 2505")
print("="*80)

# VP1 starts at position 2365
vp1_start = 2365

# Check the sequence at position 2505
site_start = 2505
site_end = site_start + 6  # SmaI recognition is 6 bp (CCCGGG)
...
print(f"\nMutation required:")
mutations = []
for i, (curr, target) in enumerate(zip(current_seq, smai_seq), start=1):
    if curr != target:
        pos = site_start + i - 1
...
for mutation_pos in mutations:
    ...
    mutated_plasmid[mutation_pos-1] = smai_seq[mutation_pos - site_start]  # Apply mutation
