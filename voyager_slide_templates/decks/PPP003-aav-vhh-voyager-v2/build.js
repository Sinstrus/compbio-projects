...
async function buildPresentation() {
  console.log('Building AAV-VHH Display Platform presentation (Voyager theme v2)...\n');

  // Create new presentation
  const pres = new PptxGenJS();
  pres.layout = 'LAYOUT_16x9';
  pres.title = 'AAV-VHH Display Platform';
  ...
  try {
    const outputPath = path.join(__dirname, 'AAV_VHH_Display_Voyager_v2.pptx');
